      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          <button
            ...
            className={`w-full bg-[#FFD700] text-black py-3 px-6 rounded-lg font-medium hover:bg-white border transition-colors ${isSubmitting ? 'opacity-70 cursor-not-allowed' : ''}`}
          >
